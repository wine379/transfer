...
import ColorSwitch from '../common/colorSwitch.common.components';

// Default dark side menu
import SideMenu from '../navigation/navigation.components';
...
const Header: React.FC<IProps>  = ({sideMenu, term, menuColor, onClick}) => {
   ...
   const  _toggleClass = () => {
    ...
    const onSideMenuHandler = (activeColor: boolean): void => {
        setState({
          ...state,
          menuColor: activeColor
        })
    }
    return (
